...
class CatergoriesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        designContinueButton()
        configureContinueButtonView()
    }
    
    private func designContinueButton(){
        continueButton.layer.cornerRadius = 25
        continueButton.setTitleColor(.black, for: .highlighted)
    }
    
    private func configureContinueButtonView(){
        ...
        continueButtonView.layer.shadowRadius = 5
